...
It internally train the models, here we will train 3 models and see their differences: svr_rbf, svr_lin, svr_poly
...
Cela a pour effet d'entrainer en interne les modeles, ici nous en essayerons 3:svr_rbf, svr_lin, svr_poly
L'entrainement permet alors de faire des prédictions sur d'autres jeux de données. Ici nous avons réalisé une prédiction sur le jour 29 du mois de mars.
